...
const PAGES = [
    ...
    },
    {
        ...
        fields: [
            ...
            {
                key: 'about.blocks',
                label: 'The blocks. Each one fills the section as the visitor scrolls, so keep them few — add a third for Vision or Mission if you want one',
                type: 'list',
                now: 'Late Anwar Hossain · Manwar Hossain',
                item: [
                    { key: 'title', label: 'Heading', type: 'text' },
                    { key: 'accent', label: 'Heading — the words in red', type: 'text' },
